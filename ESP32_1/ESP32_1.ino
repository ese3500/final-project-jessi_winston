...
const char* ssid = "Ninja Turtle";     // CHANGE TO YOUR WIFI SSID
const char* password = "applepie"; // CHANGE TO YOUR WIFI PASSWORD
const char* serverAddress = "192.168.252.179"; // CHANGE TO ESP32#2'S IP ADDRESS
